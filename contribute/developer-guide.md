...
Alternatively, if you are on Windows and want to use the `make` command, install [Make for Windows](https://sourceforge.net/projects/gnuwin32/files/make/) and use it in a UNIX shell (for example, Git Bash).
